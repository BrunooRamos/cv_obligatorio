"""Evaluate torchreid ResNet50 features end-to-end on Market-1501."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Compute CMC and mAP on Market-1501 using precomputed torchreid features",
    )
    parser.add_argument(
        '--query-features',
        type=str,
        default='data/features/market1501_query_torchreid.npz',
        help='Path to the .npz file containing query features.',
    )
    parser.add_argument(
        '--gallery-features',
        type=str,
        default='data/features/market1501_test_torchreid.npz',
...
def main() -> None:
    ...
    print_results(results, dataset=f'Market-1501 (torchreid ResNet50, metric={args.metric})')
